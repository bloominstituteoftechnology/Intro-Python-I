...
into the darkness. Ahead to the north, a light flickers in the distance, but there
...
Sadly, it has already been completely emptied by earlier adventurers. The only exit is
to the south."""
)