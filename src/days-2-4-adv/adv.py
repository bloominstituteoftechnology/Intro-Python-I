...
print(f"Welcome adventurer, you are currently in {player.current_room.name}. {player.current_room.descr}")
# Write a loop that:
#
# * Prints the current room name
while True:
    print(f"You are now in {player.current_room.name}. {player.current_room.descr}")
