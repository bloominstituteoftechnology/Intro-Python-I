...
and east. """, [item["flower"], item["stick"], item['torch']]),

    'overlook': Room("Grand Overlook", """A steep cliff appears before you, falling
into the darkness. Ahead to the north, a light flickers in
the distance, but there is no way across the chasm.""", [item["rope"], item["plank"]]),
...
earlier adventurers. The only exit is to the south.""", [item["coin"], item["sword"]]),
}
