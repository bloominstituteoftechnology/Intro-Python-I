...
Note: the user should provide argument input (in the initial
call to run the file) and not
...
print out a calendar for April in 2015, but if you omit either
the year or both values,
