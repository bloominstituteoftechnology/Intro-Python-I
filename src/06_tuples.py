...
def print_tuple(tpl):
    """print_tuple prints out the contents of a passed tuple"""
    tmp_str = ""
    # Iterate through the passed tuple value
    for elm in tpl:
        print(elm)
...
# Add a comma after the value in the parentheses to tell the python interpreter that 
#  the expression is tuple
print_tuple(u)
